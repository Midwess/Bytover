...
export default function TransferBoard() {
    ...
    if (coreNotCompatible) {
        return (
            <div className="flex items-center justify-center w-full min-h-[400px] p-8">
                <div className="flex flex-col items-center gap-2 max-w-md text-center">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            Our app only supports modern browsers with advanced security features required for secure file transfers. 
