...
export function GravityBackground() {
    return <>
        <div className={"w-full md:pb-0 h-[95vh] md:h-[80vh] overflow-hidden absolute top-0 left-0 z-1 pointer-events-none"}>
            <Aurora
                colorStops={["#007bff", "#6610f2", "#007bff", "#0056b3", "#007bff"]}
                blend={0.5}
                amplitude={0.2}
                speed={0.9}
            />
