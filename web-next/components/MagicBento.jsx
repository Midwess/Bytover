...
const BentoCardGrid = ({ children, gridRef }) => {
  ...
  return (
    <div className="card-grid bento-section" ref={gridRef}>
      <div className="card-grid__column card-grid__column--left">
        {leftCards}
      </div>
      <div className="card-grid__column card-grid__column--right">
        {rightCards}
      </div>
    </div>
  );
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardsToRender.map((card, index) => {
          ...
          let gridClass = '';
          if (card.id === 'shelf') {
            gridClass = 'magic-bento-card--pos-shelf';
          } else if (card.id === 'public-share') {
            gridClass = 'magic-bento-card--pos-public-share';
          } else if (card.id === 'nearby-share') {
            gridClass = 'magic-bento-card--pos-nearby-share';
              ...
              >
                ...
                <div className="magic-bento-card__text-content">
                  ...
                  <div className="magic-bento-card__content">
                    <h2 className="magic-bento-card__title">{card.heading || card.title}</h2>
