...
export default function Header() {
    ...
    return (
        <div
            className={`fixed backdrop-blur-md bg-black/35 top-0 left-0 right-0 z-100 flex justify-between items-center w-full py-3 md:py-6 transition-all duration-300`}>
            <div className="container mx-auto flex justify-between items-center w-full">
                <div className="flex flex-row gap-2 items-center px-1 sm:px-3">
