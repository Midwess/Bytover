...
use shared::protocol::rpc::app_server::AuthenticationStart;
...
fn main() {
    ...
    gen.register_type::<LoginProvider>().unwrap();
    gen.register_type::<AuthenticationStart>().unwrap();
    ...
    gen.register_type::<AuthenticationSessionOutcome>().unwrap();
